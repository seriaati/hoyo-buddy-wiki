---
title: "Guía de pre-configuración de cuenta"
---
...
![Login Screen](../../../assets/images/hb-account/web/account-log-in.png)

Después de iniciar sesión, pueden pasar 3 cosas:

### Vincula una nueva cuenta

![Third-party Account Linking](../../../assets/images/hb-account/web/sign-up_google-link.png)
...
![Link Email](../../../assets/images/hb-account/web/link-email.png)
...
![Password and Security](../../../assets/images/hb-account/web/password-and-security.png)

En la siguiente pantalla, haz clic en "Gestión" en la sección "Contraseña y seguridad"

![Update Password](../../../assets/images/hb-account/web/update-password.png)
...
![Link to Existing Account](../../../assets/images/hb-account/web/link-existing.png)
