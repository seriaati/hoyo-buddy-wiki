...
Después de iniciar sesión, puede pasar lo siguiente:
...
<Image
  src={screenshot}
  alt="Created with only linked account"
  width={400}
/>

Sigue el mismo paso que en [Vincular correo electrónico](#vincular-correo). Tendrás que hacer clic en gestionar en cada sección para añadir un correo electrónico y una contraseña.
