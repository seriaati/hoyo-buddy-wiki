...
![登入畫面](../../../assets/images/hb-account/web/account-log-in.png)

登入後，可能出現以下三種情況：  

### 連結新帳號

![第三方帳號綁定](../../../assets/images/hb-account/web/sign-up_google-link.png)
...
![綁定電子郵件](../../../assets/images/hb-account/web/link-email.png)

這表示你使用第三方提供商登入時，Hoyoverse 已自動創建了一個帳號。點擊「綁定」。  

![密碼與安全性](../../../assets/images/hb-account/web/password-and-security.png)

在下一頁，於「密碼與安全性」部分點擊「管理」。  

![更新密碼](../../../assets/images/hb-account/web/update-password.png)
...
![綁定至現有帳號](../../../assets/images/hb-account/web/link-existing.png)
