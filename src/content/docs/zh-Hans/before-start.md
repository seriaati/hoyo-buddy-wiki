...
![登录界面](../../../assets/images/hb-account/web/account-log-in.png)

登录后，可能出现以下三种情况：  

### 链接新账号

![第三方账号绑定](../../../assets/images/hb-account/web/sign-up_google-link.png)
...
![绑定电子邮箱](../../../assets/images/hb-account/web/link-email.png)

这表示你使用第三方提供商登录时，Hoyoverse 已自动创建了一个账号。点击「绑定」。  

![密码与安全性](../../../assets/images/hb-account/web/password-and-security.png)

在下一页，于「密码与安全性」部分点击「管理」。  

![更新密码](../../../assets/images/hb-account/web/update-password.png)
...
![绑定至现有账号](../../../assets/images/hb-account/web/link-existing.png)
