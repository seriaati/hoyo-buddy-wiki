...
Sau khi đăng nhập, những điều sau có thể xảy ra:
...
### Ngày cập nhật mật khẩu gần nhất là "-" hoặc "1/1/1"

![Mật khẩu và Bảo mật](../../../assets/images/hb-account/web/password-and-security.png)

Làm theo các bước tương tự [Liên kết Email](#liên-kết-email) để đặt mật khẩu cho tài khoản của bạn.

### Tài khoản được tạo bằng Steam hoặc PlayStation

import { Image } from "astro:assets";
import screenshot from "../../../assets/images/hb-account/web/created_with_only_linked.png";

<Image
  src={screenshot}
  alt="Tài khoản chỉ được tạo bằng tài khoản liên kết"
  width={400}
/>

Làm theo các bước tương tự [Liên kết Email](#liên-kết-email). Bạn sẽ cần phải nhấp vào "Quản lý" trong mỗi phần để thêm email và mật khẩu.
