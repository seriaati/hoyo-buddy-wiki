---
title: "Hướng dẫn thiết lập trước tài khoản"
---
...
![Màn hình đăng nhập](../../../assets/images/hb-account/web/account-log-in.png)

Sau khi đăng nhập, 3 điều có thể xảy ra:

### Liên kết tài khoản mới

![Liên kết tài khoản của bên thứ ba](../../../assets/images/hb-account/web/sign-up_google-link.png)
...
![Liên kết Email](../../../assets/images/hb-account/web/link-email.png)
...
![Mật khẩu và Bảo mật](../../../assets/images/hb-account/web/password-and-security.png)

Trên màn hình tiếp theo, nhấp vào "Quản lý" trong phần "Mật khẩu và Bảo mật".

![Cập nhật Mật khẩu](../../../assets/images/hb-account/web/update-password.png)
...
![Liên kết đến Tài khoản Hiện có](../../../assets/images/hb-account/web/link-existing.png)
