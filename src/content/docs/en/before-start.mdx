...
After logging in, 4 things can happen:
...
### Password Last Updated Date is "-" or "1/1/1"

![Password and Security](../../../assets/images/hb-account/web/password-and-security.png)

Follow the same steps as [Link Email](#link-email) to set a password for your account.

### Created using linked account without any information
...
Follow the same step as [Link Email](#link-email). You will have to click manage on each section to add an email and password.
