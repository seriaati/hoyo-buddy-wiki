...
[Cho những bạn thông minh](https://github.com/seriaati/hoyo-buddy/releases/tag/v1.16.0)
...
- Sửa nhiều lỗi và cải tiến đa dạng và phiên dịch cho Tiếng Việt.
...
- (`/mimo`) Sắp xếp các mặt hàng của shop Du Lịch Mimo từ đắt nhất đến rẻ nhất khi tự động mua.
...
- (`/profile genshin`) Sữa Thiên Phú bổ sung được hiển thị trong thẻ nhóm.
...
- (`/mimo`) Đã thêm khoảng thời gian ngủ sau khi đổi mã quà tặng phần thưởng Mimo.
...
- (`/mimo`) Đã sửa lỗi bình luận bài viết không bị xóa.
...
Nhật ký thay đổi trước đó đã được viết trong kênh #updates trong [máy chủ Discord](https://link.seria.moe/hb-dc) của chúng tôi.
